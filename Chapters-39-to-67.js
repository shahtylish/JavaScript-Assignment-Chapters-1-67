...
document.write("<br> Remove Vowels: " + remove_vowels("Shahzaib Abdul Wajid Khan"));
...
document.getElementById("link").setAttribute('onclick', "alert('Hi')");

//Task 2:
var images = document.getElementsByClassName("images");
for(var i = 0; i < images.length; i++){
    images[i].style.cursor = 'pointer';
    images[i].setAttribute('onclick', "alert('Thanx for purchasing a phone from us!')");
}
...
// iv.
var fname = document.getElementById("first-name").value = "Shahzaib";
document.write("<br> Fill input value of element whose id='first-name': " + fname + "<br>");
// v.
var lname = document.getElementById("last-name").value = "Khan";
document.write("Fill input value of element whose id='last-name': " + lname + "<br>");
var email = document.getElementById("email").value = "shahwajid.sk@gmail.com";
